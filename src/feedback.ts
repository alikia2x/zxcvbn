...
export function get_feedback(score: number, sequence: IAnyMatch[]): IFeedbackItem {
	// starting feedback
...
export function get_match_feedback(match: IAnyMatch, is_sole_match: boolean): IFeedbackItem | undefined {
...
export function get_dictionary_match_feedback(match: IDictionaryMatch, is_sole_match: boolean): IFeedbackItem {
	let warning = "";
